...
/* Recipients */
    ...
    $url - str_replace('registerUserController.php','confirm.php',$url);
    $mail->Body    = '
    <div style="height:100vh;background-color:#EDEDED;">
        ...
        <a href="'.$url.'?'.$code.'" style="padding-top:25px;margin:0 auto;text-decoration: underline;color:blue;">'.$url.'?'.$code.'</a>
</div>
    </div>
